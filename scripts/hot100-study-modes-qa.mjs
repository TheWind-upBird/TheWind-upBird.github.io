...
for(const [name,src] of [['product-catalog.js',catalog],['learning-policy.js',policy],['study-modes.js',modes],['product-library.js',library],['mastery-pass.js',mastery]]){
...
ok(sw.includes("CACHE='hot100-shell-v26'"),'service worker cache version must be v26');
