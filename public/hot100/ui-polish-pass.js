...
html[data-theme="wa2"] #page-home>.title:after{content:none!important;display:none!important}
...
bindMasteryButtons();
const observer=new MutationObserver(()=>bindMasteryButtons());observer.observe(document.body,{childList:true,subtree:true});
